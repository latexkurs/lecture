...
% © 2019–2022 Maximilian Jala, CC-by-sa
...
\begin{aufgabe}[6]{Schöne Tabelle}
	...
	\end{enumerate}
	\abgabe{Den Quellcode und fertiges Dokument als Abgabe in Moodle (Zip aller Dateien). Bitte auf aussagekräftige Namen der Dateien achten!}
\end{aufgabe}

\newpage
\lösung{02_loesung_schoen}
\clearpage
...
\end{center}
	...
	\abgabe{Den Quelltext und Ausgabe als PDF per Moodle abgeben (Zip aller Dateien). Bitte auf aussagekräftige Namen der Dateien achten!}
\end{aufgabe}

\lösung{02_loesung_bunt}
