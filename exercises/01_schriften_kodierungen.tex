...
\begin{aufgabe}[6]{Schriften}
	...
	\begin{enumerate}[label=\alph*)]
		...
		Schreiben Sie ein kurzes Testdokument mit \hologo{XeLaTeX}, in dem beide Schriften vorkommen. Überlegen Sie sich dazu, welche Pakete Sie benötigen, welche Befehle nötig sind und welche Definitionen geschickt und sinnvoll sind. (Tipp: \texttt{\textbackslash setmainfont} u.\,ä., manchmal haben die Schriftarten noch ein O [Buchstabe] hinter dem Namen)
	\end{enumerate}
		\abgabe{Beide Quelltexte und PDF in Moodle hochladen.}
\end{aufgabe}
...
\begin{aufgabe}[6]{Liste mit Umlauten}
	...
	\end{enumerate}
		\abgabe{Quelltext per Zip in Moodle hochladen.}
\end{aufgabe}
