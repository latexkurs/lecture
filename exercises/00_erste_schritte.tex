...
\begin{aufgabe}[12]{Minimales \TeX-Dokument}
	...
	\end{enumerate}
	\abgabe{Beide Quelltexte und das fertige \TeX-Dokument (das PDF von Teil \ref{aufg:texdoc} und \ref{aufg:latexdoc}) als ZIP im Moodle abgeben. Form |zettel0\_musterfrau.zip|}
\end{aufgabe}
