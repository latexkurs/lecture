...
\begin{aufgabe}[12]<2>{Präsentation mit beamer}
	...
	\begin{enumerate}[label=\alph*)]
		...
		Beispielcode für einen \LaTeX-Befehl gezeigt werden (etwas wie |\includegraphics|, |\textsf|, |\color|
		 o.\,ä.).
	
		Schreiben Sie mindestens drei Codezeilen in diesem Beispiel. Falls noch Zeit bleibt, geben Sie auf der
		gleichen Folie ein paar erklärende Stichworte zum Code.
		...
		geübt werden: Fügen Sie vor jeder Folie eine |\section| mit (sinnvollem) Namen ein und 
